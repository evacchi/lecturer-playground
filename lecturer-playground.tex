...
\setparameter fresh-cut-day:
  tropiteal    = ".0  .66 .78"
  whitetrash   = ".97 .94 .90"
  atomicbikini = ".68 .89 .22"

\newcommand{\withpalette}[1]{
  \newcommand{\palette}[1]{
   \usevalue #1: ##1
  }
}
...
\newcommand{\updatepalette} {
  \setpalettekey{title-slide-background}
  \setpalettekey{title-slide-foreground}
}

\withpalette{fresh-cut-day}
\setparameter palette:
  title-slide-background = { \palette{tropiteal} }
  title-slide-foreground = { \usevalue fresh-cut-day : whitetrash }
...
% \definecolor{whitetrash}{rgb}{.97 .94 .90}
